...
export default function DisplayData() {
  ...
  const parsedDynamicFields: { title: string; value: string }[] = dynamicFields
            ...
            >
              <View style={{ justifyContent: "center", alignItems: "center" }}>
                ...
                <View style={{ flexDirection: "row" }}>
                  <Text style={{ paddingHorizontal: 4, fontWeight: "700" }}>
                    BORN
                  </Text>
                  <Text>{dob}</Text>
                </View>
                ...
                <Text style={styles.boldText}>
                  Favorite movie, band, book, author
                </Text>
                ...
                {parsedDynamicFields.length > 0 && (
                  <View>
                    {parsedDynamicFields.map(
                      (
                        field: { title: string; value: string },
                        index: number
                      ) => (
                        <View key={index}>
