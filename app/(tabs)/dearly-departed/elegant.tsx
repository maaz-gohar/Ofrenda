                ...
                <View style={[styles.main]}>
                    ...
                    <ScrollView contentContainerStyle={{ paddingHorizontal: 20 }} bounces={false} >
                        <View style={{ flexDirection: "row", alignItems: "center", paddingVertical: 10 }}>
                            <FrameComponent text="Ofrenda" onPress={() => router.push('/dearly-departed/select-ofrenda')} />
                            <FrameComponent text="Elegant" isGradient={true} onPress={() => router.push('/dearly-departed/elegant')} />
