...
export default function DisplayData() {
    ...
    const parsedDynamicFields: { title: string; value: string }[] = dynamicFields ? JSON.parse(dynamicFields) : [];
                        ...
                        >
                            <View style={{ justifyContent: "center", alignItems: "center" }}>
                                ...
                                {parsedDynamicFields.length > 0 && (
                                    <View>
                                        {parsedDynamicFields.map((field: { title: string; value: string }, index: number) => (
                                            <View key={index}>
