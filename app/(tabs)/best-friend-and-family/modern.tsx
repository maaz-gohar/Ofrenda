                ...
                <Wrapper>
                    ...
                    <ScrollView contentContainerStyle={{ paddingHorizontal: 20 }} bounces={false} >
                        <View style={{ flexDirection: "row", alignItems: "center", paddingVertical: 10 }}>
                            <FrameComponent text="Classic" onPress={() => router.push('/best-friend-and-family/select-frames')} />
                            <FrameComponent text="Vintage" onPress={() => router.push('/best-friend-and-family/vintage')} />
                            <FrameComponent text="Modern" isGradient={true} onPress={() => router.push('/best-friend-and-family/modern')} />


                        </View>
                    </ScrollView>
                    <Text>Modern Screen</Text>
