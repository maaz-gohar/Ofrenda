...
// import BucketListComponent from '../../../components/bucket-list/bucketListComponent';
...
// import BucketListComponent from '@/components/bucket-list/bucket-list-component';
// import React from 'react';
// import { styles } from './select-bucket-list';
                        ...
                        <ScrollView bounces={false} style={{ height: 300 }} nestedScrollEnabled={true} contentContainerStyle={{ flexGrow: 1 }}>
                            <View style={styles.row}>
                                <BucketListComponent
                                    ...
                                    onPress={() => handleUpload('/bucket-list/bucket-lists', 'Destinations')}
                                />
                                <BucketListComponent
                                    showIcon={false}
                                    showText={true}
                                    ...
                                    image={require('../../../assets/images/Group 1508.png')}
                                    IconName="locked"
                                    onPress={() => handleUpload('/bucket-list/memory', 'Kindergarten')}
                                />
                                <BucketListComponent
                                    showIcon={false}
                                    showText={true}
                                    ...
                                    image={require('../../../assets/images/Group 1508.png')}
                                    onPress={() => handleUpload('/bucket-list/thoughts', 'Politics')}
                                />
                            </View>
                            ...
                            <View style={styles.row}>
                                <BucketListComponent
                                    ...
                                    route="/bucket-list/bucket-lists"
                                    image={require('../../../assets/images/Group 1508.png')}
                                    onPress={() => handleUpload('/bucket-list/bucket-lists', 'Activities')}
                                />
                                <BucketListComponent
                                    showIcon={false}
                                    showText={true}
                                    ...
                                    image={require('../../../assets/images/Group 1508.png')}
                                    IconName="locked"
                                    onPress={() => handleUpload('/bucket-list/memory', 'Junior School')}
                                />
                                <BucketListComponent
                                    showIcon={false}
                                    showText={true}
                                    ...
                                    route="/bucket-list/thoughts"
                                    image={require('../../../assets/images/Group 1508.png')}
                                    onPress={() => handleUpload('/bucket-list/thoughts', 'Religion')}
                                />
                            </View>
                            ...
                            <View style={styles.row}>
                                <BucketListComponent
                                    ...
                                    route="/bucket-list/bucket-lists"
                                    image={require('../../../assets/images/Group 1508.png')}
                                    onPress={() => handleUpload('/bucket-list/bucket-lists', 'Restaurants')}
                                />
                                <BucketListComponent
                                    showIcon={false}
                                    showText={true}
                                    ...
                                    image={require('../../../assets/images/Group 1508.png')}
                                    IconName="locked"
                                    onPress={() => handleUpload('/bucket-list/memory', 'Best Friends')}
                                />
                                <BucketListComponent
                                    showIcon={false}
                                    showText={true}
                                    ...
                                    route="/bucket-list/thoughts"
                                    image={require('../../../assets/images/Group 1508.png')}
                                    onPress={() => handleUpload('/bucket-list/thoughts', 'Friendship')}
                                />
                            </View>
                            ...
                            <View style={styles.row}>
                                <BucketListComponent
                                    ...
                                    route="/bucket-list/bucket-lists"
                                    image={require('../../../assets/images/Group 1508.png')}
                                    onPress={() => handleUpload('/bucket-list/bucket-lists', 'Holidays')}
                                />
                                <BucketListComponent
                                    showIcon={false}
                                    showText={true}
                                    ...
                                    image={require('../../../assets/images/Group 1508.png')}
                                    IconName="locked"
                                    onPress={() => handleUpload('/bucket-list/memory', 'College Days')}
                                />
                                <BucketListComponent
                                    showIcon={false}
                                    showText={true}
                            ...
                            <View style={styles.row}>
                                <BucketListComponent
                                    ...
                                    route="/bucket-list/bucket-lists"
                                    image={require('../../../assets/images/Group 1508.png')}
                                    onPress={() => handleUpload('/bucket-list/bucket-lists', 'Recipes')}
                                />
                                <BucketListComponent
                                    showIcon={false}
                                    showText={true}
                                ...
                                <BucketListComponent
                                    ...
                                    route="/bucket-list/thoughts"
                                    image={require('../../../assets/images/Group 1508.png')}
                                    onPress={() => handleUpload('/bucket-list/thoughts', 'Social Media')}
                                />
                            </View>
                            <View style={styles.row}>
                                <BucketListComponent
                                    ...
                                    image={require('../../../assets/images/Group 1508.png')}
                                    onPress={() => handleUpload('/bucket-list/payment-method', 'Holidays')}
                                />
                                <BucketListComponent
                                  showIcon={true}
                                    showText={false}
                                    ...
                                    route="/bucket-list/payment-method"
                                    image={require('../../../assets/images/Group 1508.png')}
                                    onPress={() => handleUpload('/bucket-list/payment-method', 'College Days')}
                                />
                                <BucketListComponent
                                     showIcon={true}
                                     showText={false}
                                    ...
                                    route="/bucket-list/payment-method"
                                    image={require('../../../assets/images/Group 1508.png')}
                                    onPress={() => handleUpload('/bucket-list/payment-method', 'Music')}
                                />
                            </View>
                            <View style={styles.row}>
                                <BucketListComponent
                        ...
                        <View style={styles.bucketContainer2}>
                            ...
                            <View style={styles.row}>
                                <BucketListComponent
                                    ...
                                    image={require('../../../assets/images/Group 1508.png')}
                                    onPress={() => handleUpload('/bucket-list/natural-disaster', 'Holidays')}
                                />
                                <BucketListComponent
                                  showIcon={true}
                                    showText={true}
