      ...
      >
        ...
        <View style={styles.main}>
          <Text style={styles.paymentText}>
            Select payment method or add new payment method
          </Text>
            ...
            <View style={styles.paymentButtonsContainer}>
              <TouchableOpacity
                style={[
                  ...
                  selectedPayment === 5 && styles.selectedPaymentButton,
                ]}
              ...
              <TouchableOpacity
                style={[
                  styles.paymentButton,
                  selectedPayment === 10 && styles.selectedPaymentButton,
                ]}
              ...
              <TouchableOpacity
                style={[
                  styles.paymentButton,
                  selectedPayment === 20 && styles.selectedPaymentButton,
                ]}
          ...
          {selectedPayment !== null && (
            <View style={styles.selectedPaymentContainer}>
              <Text style={styles.selectedPaymentText}>
                Selected Payment: ${selectedPayment.toFixed(1)}
              </Text>
            </View>
          )}
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push("/bucket-list/add-card")}
          >
          ...
          <TouchableOpacity onPress={() => router.push("/bucket-list/summary")}>
            <LinearGradient colors={[b1, b2]} style={styles.details}>
