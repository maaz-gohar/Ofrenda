        ...
        <View style={[styles.main]}>
          ...
          <LinearGradient colors={[b1, b2]} style={styles.gradient}>
            <View style={styles.price}>
              ...
              <Text
                style={{ textAlign: "center", paddingBottom: 20, width: 300 }}
              >
                Package includes 16 photo frames, 12 backgrounds, and 100
                customizable lists for comprehensive creative projects.
              </Text>
              <View style={styles.innerPlan}>
          ...
          <View style={styles.checkboxContainer}>
            <TouchableOpacity onPress={ToggleCheckBox} style={styles.checkbox}>
              {isCheck && <AntDesign name="check" color="#000" size={18} />}
            </TouchableOpacity>
            <Text style={{ fontSize: 16 }}>Accept all terms & condition</Text>
          </View>
        </View>
