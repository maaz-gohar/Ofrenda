...
interface CollegeDesignComponentProps {
    imagePath: any; 
    showIcon?: boolean;
}

export default function CollegeDesignComponent({ imagePath, showIcon = false }: CollegeDesignComponentProps) {
                        ...
                        <TouchableWithoutFeedback>
                            <View style={styles.modalContent}>
                                ...
                                <View style={styles.addDearly}>
                                    <TouchableOpacity
                                        onPress={() => router.push('/best-friend-and-family/select-college-design')}
                                    >
