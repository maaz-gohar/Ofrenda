...
interface HeaderProps {
    ...
    setting?: boolean;
    description: string;
    descriptioncondition?: boolean;
    gradientColors?: string[];
}

export default function Header({ title, name, showIcon = false, setting = false, description, descriptioncondition = false, gradientColors = ["#FFC70BE5", "#ffe9a1"] }: HeaderProps) {
