...
interface AncestorsImageProps {
    imagePath: { uri: string }; // Adjust the type based on your actual imagePath structure
    showIcon?: boolean;
}

const AncestorsImage: React.FC<AncestorsImageProps> = ({ imagePath, showIcon = false }) => {
