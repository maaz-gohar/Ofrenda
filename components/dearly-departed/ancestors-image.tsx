...
const AncestorsImage: React.FC<AncestorsImageProps> = ({
  ...
  const isSubmitted =
    typeof hasSubmitted === "object" ? hasSubmitted[frameId] : hasSubmitted;
  ...
  const handleViewDetails = () => {
    router.push({
      pathname: "/(dearly-departed)/(home)/successfully",
      params: {
        ...
        <TouchableWithoutFeedback onPress={closeModal}>
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              ...
              <Image source={imagePath} style={styles.modalFrameImage} />
