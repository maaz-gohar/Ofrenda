...
const TabBar = () => {
  ...
  const handleTabPress = async (
    tab: "main-screen" | "notification" | "profile"
  ) => {
  ...
  const isTabActive = (tabName: string) => {
    ...
    if (
      tabName === "main-screen" &&
      (pathname.includes("main-screen") || pathname === "/")
    )
      return true;
    if (tabName === "notification" && pathname.includes("notification"))
      return true;
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.tabContent}>
          ...
          <Text
            style={[
              styles.text,
              isTabActive("notification") && styles.activeText,
            ]}
          >
            Notification
          </Text>
          {isTabActive("notification") && (
      ...
      >
        <View style={styles.tabContent}>
          ...
          />
          <Text
            style={[styles.text, isTabActive("profile") && styles.activeText]}
          >
            Profile
          </Text>
